   ...
   if(dp[idx][buy]!=-1){
    return dp[idx][buy];
        ...
        if(buy){
            ...
            take=prices[idx]+solve(idx+1,1,prices,dp);//tm bech diya to tumko buy ko 1 karna hoga..kyoki ab tm phir kharidne ke liye ready ho..ab tm koi chiz becha hai to tumhare pass paisa aaya hai to (+) likhe hai
